...
func main() {
	// This example is to launch a browseWhen you log into your github account, and you want to reuse the login session for automation task. You can use the launcher.NewUserMode to launch your regular user browser. Rod will be just like a browser extension:r remotely, not connect to a running browser remotely,
