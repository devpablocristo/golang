...
import (
	...
	"github.com/devpablocristo/golang/06-projects/items/gin/items-final/internal/adapters/handler/presenter"
	"github.com/devpablocristo/golang/06-projects/items/gin/items-final/internal/entity"
	"github.com/devpablocristo/golang/06-projects/items/gin/items-final/internal/usecase"
...
func (ctrl ItemHandler) GetAllItems(c *gin.Context) {
...
func (ctrl ItemHandler) AddItem(c *gin.Context) {
...
func (ctrl *ItemHandler) GetItem(c *gin.Context) {
	idParam := c.Param("id")
