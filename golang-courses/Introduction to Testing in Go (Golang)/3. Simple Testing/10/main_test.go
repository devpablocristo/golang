...
func Test_checkNumbers(t *testing.T) {
	// here are written all the test cases that I want to check
	tests := []struct {
		name     string
		input    string
		expected string
	...
	//get a struct each loop
	for _, e := range tests {
		// every time you want to similute user input
		input := strings.NewReader(e.input)
		// what needs checkNumbers is a bufio.NewScanner
		// input satisfy the bufio.NewScaner parameter
