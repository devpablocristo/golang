...
func (c *greeterClient) SayHello(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/greetsrv.Greeter/SayHello", opts...)
	if err != nil {
		return nil, err
	}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/greeter/proto/greet.proto",
}
