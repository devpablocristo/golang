...
func NewRepo(dao PortMongoPersonDAO) port.Repo {
	return &Repo{
		dao: dao,
	}
}

func (r *Repo) CreatePerson(ctx context.Context, event *domain.Person) (*domain.Person, error) {
...
// func (r *Repo) DeleteEvent(ctx context.Context, eventID string) (*domain.Person, error) {
...
// func (r *Repo) HardDeleteEvent(ctx context.Context, eventID string) (*domain.Person, error) {
...
// func (r *Repo) UpdateEvent(ctx context.Context, event *domain.Person, eventID string) (*domain.Person, error) {
...
// func (r *Repo) ReviveEvent(ctx context.Context, eventID string) (*domain.Person, error) {
...
// func (r *Repo) GetEvent(ctx context.Context, eventID string) (*domain.Person, error) {
