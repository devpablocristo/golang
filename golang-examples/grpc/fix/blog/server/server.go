...
func (*server) ListBlog(_ *pb.ListBlogRequest, stream pb.BlogService_ListBlogServer) error {
	...
	for cur.Next(context.Background()) {
		...
		stream.Send(&pb.ListBlogResponse{Blog: dataTopb(data)}) // Should handle err
	}
